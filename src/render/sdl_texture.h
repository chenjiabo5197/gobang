...
public:
    ...
    SDLTexture(const int& width, const int& height);
    ...
    */
    void render(SDL_Renderer* gRenderer, int x, int y, SDL_Rect* clip = nullptr, double angle = 0.0, SDL_Point* center = nullptr, SDL_RendererFlip flip = SDL_FLIP_NONE);
