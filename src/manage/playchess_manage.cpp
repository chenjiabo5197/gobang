...
void PlaychessManage::init()
{
    ...
    for (int i = 0; i < this->array_length; i++)
    {
        this->playchess_buttons[i]->loadResource(g_main_window->getWindow(), g_main_window->getRenderer());
    }
...
void PlaychessManage::startRender()
{
    ...
    for (int i = 0; i < this->array_length; i++)
    {
        this->playchess_buttons[i]->buttonRender(g_main_window->getRenderer());
    }
